...
BattleController::BattleController(const ScreenSize* const screen, std::vector<std::vector<Ceil>>& ceils, std::shared_ptr<Player> player, std::shared_ptr<Enemy> enemy, BattleTurn turn)
    : screen(screen),
      ceils(ceils),
      player(player),
      enemy(enemy),
